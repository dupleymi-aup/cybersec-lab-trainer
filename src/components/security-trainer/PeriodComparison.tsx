          ...
          >
            <Card className="border-border">
              <CardContent className="p-4">
                <p className="text-muted-foreground mb-2 text-xs">{kpi.label}</p>
              ...
              <div className="space-y-2">
                {biggestGains.map((m) => (
                  <div key={m.module} className="flex items-center justify-between text-sm">
                    <span>{m.module}</span>
                    <Badge className="bg-emerald-100 text-emerald-700">+{m.periodA - m.periodB}%</Badge>
                  </div>
                ))}
              </div>
            </CardContent>
            ...
            <CardContent className="p-5">
              ...
              <div className="space-y-2">
                {biggestLosses.map((m) => (
                  <div key={m.module} className="flex items-center justify-between text-sm">
                    <span>{m.module}</span>
                    <Badge className="bg-red-100 text-red-700">{m.periodA - m.periodB}%</Badge>
                  </div>
                ))}
              </div>
            </CardContent>
