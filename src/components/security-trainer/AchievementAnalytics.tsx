            ...
            <div className="h-[400px]">
              <ResponsiveContainer width="100%" height="100%">
                <BarChart layout="vertical" data={barData} margin={{ left: 80 }}>
                  ...
                  <Tooltip formatter={(value: unknown, _name, props) => {
                    const p = props.payload as { unlocked?: number; total?: number };
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 mb-1">
                          ...
                          <Badge className={`text-[10px] border-0 ${rarityBgColors[item.rarity]}`}>
