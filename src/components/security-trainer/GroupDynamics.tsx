...
import {
  Loader2, AlertTriangle, Users, TrendingUp, Heart, ArrowUpRight, ArrowDownRight, Minus,
} from 'lucide-react';
                  ...
                  <div className="h-[150px]">
                    <ResponsiveContainer width="100%" height="100%">
                      <AreaChart data={g.activityTimeline}>
                        ...
                        <Tooltip />
                        <Area type="monotone" dataKey="activeStudents" name="Активные" stroke="#6366f1" fill="#6366f1" fillOpacity={0.2} strokeWidth={2} />
                        <Area type="monotone" dataKey="quizAttempts" name="Квизы" stroke="#10b981" fill="#10b981" fillOpacity={0.2} strokeWidth={2} />
                      </AreaChart>
                    </ResponsiveContainer>
                  </div>
                )}
            ...
            <div className="h-[200px]">
              <ResponsiveContainer width="100%" height="100%">
                <LineChart data={overallTrends}>
                  ...
                  <Tooltip />
                  <Line type="monotone" dataKey="avgHealthScore" name="Ср. здоровье" stroke="#f43f5e" strokeWidth={2} dot={false} />
                  <Line type="monotone" dataKey="totalActive" name="Активных" stroke="#6366f1" strokeWidth={2} dot={false} />
                </LineChart>
              </ResponsiveContainer>
            </div>
          </CardContent>
