...
export default function ExecutiveSummaryExport({
  groupId,
  days,
}: {
  groupId?: string;
    ...
    try {
      ...
      const kpiData = [
        ...
        [
          ...
          trends.completion === "up"
            ? "+"
            : trends.completion === "down"
              ? "-"
              : "",
        ],
        [
      ...
      if (recentActivity.length > 0) {
        ...
        const activityTable = recentActivity
          .slice(0, 15)
          .map((a) => [a.fullName, a.details, formatDate(a.timestamp)]);
