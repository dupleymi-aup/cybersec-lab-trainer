        ...
        <CardContent className="p-5">
          ...
          <div className="space-y-3">
            {path.map((entry, i) => (
              ...
              >
                <div className="bg-secondary hover:bg-muted flex items-center gap-4 rounded-lg p-3 transition-colors">
                  {/* Step number */}
                  ...
                  <div className="min-w-0 flex-1">
                    <div className="mb-1 flex items-center justify-between">
                      <p className="truncate text-sm font-semibold">{entry.moduleName}</p>
                  ...
                  {i > 0 && dropOffRates[i] > 0 && (
                    <div className="flex-shrink-0 text-xs font-medium text-red-500">-{dropOffRates[i]}%</div>
                  )}
                </div>
              </motion.div>
            ))}
              ...
              <tbody>
                {path.map((entry, i) => (
                  ...
                  >
                    ...
                    <td className="px-3 py-2.5 font-medium">{entry.moduleName}</td>
                    <td className="px-3 py-2.5 text-right">{entry.completedCount}</td>
                    <td className="px-3 py-2.5 text-right">{totalStudents}</td>
                    ...
                    <td className="px-3 py-2.5 text-right">
                      {i > 0 && dropOffRates[i] > 0 ? (
                        <span className="font-medium text-red-500">-{dropOffRates[i]}%</span>
                      ) : (
