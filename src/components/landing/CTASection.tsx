        ...
        <motion.div initial={{opacity: 0, y: 30}} whileInView={{opacity: 1, y: 0}} viewport={{once: true}} transition={{duration: 0.6}} className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-3 gap-6 mb-12 max-w-2xl mx-auto">
            <div className="text-center">
              <Users className="w-6 h-6 text-violet-500 mx-auto mb-2" aria-hidden="true" />
              <div className="text-2xl font-bold text-foreground">1000+</div>
              <div className="text-sm text-muted-foreground">{t("students")}</div>
            </div>
            <div className="text-center">
              <Trophy className="w-6 h-6 text-amber-500 mx-auto mb-2" aria-hidden="true" />
              <div className="text-2xl font-bold text-foreground">500+</div>
              <div className="text-sm text-muted-foreground">{t("certificates")}</div>
            </div>
            <div className="text-center">
              <Clock className="w-6 h-6 text-emerald-500 mx-auto mb-2" aria-hidden="true" />
              <div className="text-2xl font-bold text-foreground">30 {t("registration")}</div>
              <div className="text-sm text-muted-foreground">{t("registration")}</div>
            </div>
          </div>
          <div className="text-center">
            ...
            <p className="text-muted-foreground text-sm mt-4">{t("disclaimer")}</p>
          </div>
        </motion.div>
      </div>
    </section>
