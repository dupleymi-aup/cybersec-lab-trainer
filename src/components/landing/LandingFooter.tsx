      ...
      <div className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-12">
          <div className="lg:col-span-2">
            ...
            <div className="flex gap-3">
              <a
                ...
                className="flex items-center justify-center w-10 h-10 rounded-xl bg-accent hover:bg-accent/80 text-muted-foreground hover:text-foreground transition-all"
                aria-label="GitHub"
              >
          ...
          <nav
            ...
            className="lg:col-span-4 grid grid-cols-2 md:grid-cols-4 gap-8 col-span-full"
          >
