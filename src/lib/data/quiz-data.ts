...
export const quizQuestions: QuizQuestion[] = [
  ...
  },
  {
    ...
    options: ['Использование HTTPS', 'CSRF-токены (anti-CSRF tokens)', 'Сложные пароли', 'Rate Limiting'],
    correctIndex: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['Минимум 6 символов', 'Минимум 8 символов', 'Минимум 12 символов', 'Минимум 4 символа'],
    correctIndex: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['X-Content-Type-Options', 'X-Frame-Options: DENY', 'Strict-Transport-Security', 'X-XSS-Protection'],
    correctIndex: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['<div>', '<span>', '<svg><script>...</script></svg> или <img src=x onerror=...>', '<p>'],
    correctIndex: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['SameSite=None', 'SameSite=Lax', 'SameSite=Strict', 'SameSite=Block'],
    correctIndex: 3,
    explanation:
  ...
  // --- Additional OWASP A05 (Security Misconfiguration) Questions ---
  {
    ...
    options: ['X-Frame-Options', 'X-Content-Type-Options: nosniff', 'Content-Security-Policy', 'X-XSS-Protection'],
    correctIndex: 0,
    explanation:
  ...
  },
  {
    ...
    options: ['helmet.xssFilter()', 'helmet.frameguard()', 'helmet.hsts()', 'helmet.dnsPrefetchControl()'],
    correctIndex: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['Фишинг через QR-коды', 'Фишинг через голосовые сообщения', 'Атака через PDF', 'Спам в мессенджерах'],
    correctIndex: 2,
  ...
  },
  {
    ...
    options: ['IDN homograph', 'Тайпосквоттинг — визуальное сходство', 'Подмена DNS', 'Поддомен легитимного сайта'],
    correctIndex: 0,
  ...
  },
  {
    ...
    options: ['Фишинг через SMS', 'Фишинг через соцсети', 'Фишинг через поиск', 'Фишинг через ПО'],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ['p=none', 'p=quarantine или p=reject', 'p=monitor', 'DMARC не защищает'],
    correctIndex: 2,
  ...
  },
  {
    ...
    options: ['Тайпосквоттинг', 'Субдоменная имперсонация', 'IDN homograph', 'Открытый редирект'],
    correctIndex: 3,
  ...
  },
  {
    ...
    options: ['Голосовой фишинг', 'Визуальный фишинг', 'Видео-фишинг', 'Фишинг через VM'],
    correctIndex: 0,
  ...
  },
  {
    ...
    options: ['Сканирование портов и сервисов', 'Анализ SQL-инъекций', 'Генерация паролей', 'Шифрование'],
    correctIndex: 2,
  ...
  },
  {
    ...
    options: ['Сканирует порты', 'Автообнаружение SQL-инъекций', 'Кеширует запросы', 'Оптимизирует БД'],
    correctIndex: 0,
  ...
  },
  {
    ...
    options: ['Перебор директорий и DNS', 'Сканирует SQLi', 'Анализирует XSS', 'Декомпилирует JS'],
    correctIndex: 3,
  ...
  },
  {
    ...
    options: ['Сканирует опасные файлы', 'Анализирует бинарники', 'Декодирует JWT', 'Генерирует SSL'],
    correctIndex: 1,
