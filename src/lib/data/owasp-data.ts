...
app.get('/api/orders/:orderId', (req, res) => {
  ...
  res.json(order);
    ...
    toolsForTesting:
      "Burp Suite (Autorize extension), OWASP ZAP, Postman для ручного тестирования IDOR",
    furtherReading:
      "OWASP Testing Guide v4.2 — Ch. 5.1 Testing Role Definitions, Ch. 5.2 Testing User Registration",
  },
  {
    id: "a02",
    code: "A02:2021",
...
const user = {
  ...
  creditCard: encryptData(cardNumber, ENCRYPTION_KEY)
    ...
    furtherReading:
      "OWASP Cryptographic Cheat Sheet, NIST SP 800-57 Key Management",
  },
  {
    id: "a03",
    code: "A03:2021",
...
const user = await prisma.user.findUnique({
  where: { username }
    ...
    toolsForTesting:
      "SQLMap, NoSQLMap, OWASP ZAP, Burp Suite (Intruder), sqlninja",
    furtherReading:
      "OWASP SQL Injection Prevention Cheat Sheet, PortSwigger Web Security Academy — SQLi",
  },
  {
    id: "a04",
    code: "A04:2021",
...
app.post('/api/verify-otp', otpLimiter, (req, res) => {
  ...
  if (req.body.code === storedCode) {
    ...
    toolsForTesting:
      "OWASP Threat Dragon, Microsoft STRIDE, Burp Suite (Rate Limit testing)",
...
if (process.env.NODE_ENV === 'production') {
  ...
  // Отладочные эндпоинты ТОЛЬКО в разработке
    ...
    cvssExample: "CVSS:3.1/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:N/A:N (Score 7.5)",
    toolsForTesting:
      "Nikto, Nmap NSE scripts, testssl.sh, SecurityHeaders.com, Mozilla Observatory",
...
`,
    ...
    cvssExample:
      "CVSS:3.1/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:H (Score 9.8) — Log4Shell",
    toolsForTesting:
      "npm audit, yarn audit, Snyk, Dependabot, OWASP Dependency-Check, Retire.js",
    furtherReading:
      "OWASP Vulnerable Components Cheat Sheet, Sonatype State of the Software Supply Chain",
  },
  {
    id: "a07",
    code: "A07:2021",
...
app.post('/login', loginLimiter, async (req, res) => {
  ...
  if (user && await bcrypt.compare(password, user.passwordHash)) {
    ...
    toolsForTesting:
      "Hydra, John the Ripper, hashcat, Burp Suite (Intruder), OWASP JWT Inspector",
    furtherReading:
...
const result = math.evaluate(sanitizedExpression);`,
    ...
    cvssExample:
      "CVSS:3.1/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:H (Score 9.8) — RCE via deserialization",
    toolsForTesting:
      "ysoserial, Burp Suite (Serializer), JWT.io, OWASP JWT Inspector",
    furtherReading:
      "OWASP Deserialization Cheat Sheet, PortSwigger — Insecure Deserialization",
  },
  {
    id: "a09",
    code: "A09:2021",
...
app.post('/login', (req, res) => {
  ...
  if (user) {
    ...
    cvssExample:
      "CVSS:3.1/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:N/A:N (Score 7.5) — без мониторинга",
    toolsForTesting:
      "ELK Stack, Splunk, Graylog, Wazuh, OSSEC, Falco (runtime security)",
    furtherReading:
      "OWASP Logging Cheat Sheet, NIST SP 800-92 Guide to Computer Security Log Management",
  },
  {
    id: "a10",
    code: "A10:2021",
...
app.get('/api/fetch-url', async (req, res) => {
  try {
    ...
    cvssExample:
      "CVSS:3.1/AV:N/AC:L/PR:N/UI:N/S:C/C:H/I:H/A:N (Score 9.0) — Cloud metadata access",
    toolsForTesting:
      "Burp Suite (Collaborator), SSRFmap, dig/nslookup, AWS metadata endpoint tester",
    furtherReading:
      "OWASP SSRF Prevention Cheat Sheet, PortSwigger — SSRF Vulnerabilities",
  },
];
