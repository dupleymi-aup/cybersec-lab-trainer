...
export const achievements = [
  ...
  },
  {
    ...
    description:
      "Используйте все инструменты в модуле «Инструменты безопасности».",
  ...
  },
  {
    ...
    description:
      "Правильно решите минимум 8 из 15 задач безопасного кодирования.",
  ...
  },
  {
    ...
    description:
      "Изучите все 12 Security Headers и правильно ответьте на квизы.",
