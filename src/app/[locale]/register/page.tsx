    ...
    <div className="min-h-screen flex items-center justify-center bg-background p-4">
      ...
      >
        <div className="text-center mb-8">
          <Link
            href={`/${locale}`}
            className="inline-flex items-center justify-center w-16 h-16 bg-violet-600 rounded-2xl mb-3 shadow-lg shadow-violet-600/20 hover:bg-violet-700 transition"
          >
