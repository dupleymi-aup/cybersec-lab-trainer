...
- Name: registration-2fa-binary.spec.ts >> Registration Flow >> should navigate to login from register
- Location: e2e\registration-2fa-binary.spec.ts:16:7
...
Call log:
  - waiting for getByRole('link', { name: /войти/i })
    - locator resolved to <a href="/login" class="text-primary hover:text-primary/80 font-medium">Войти</a>
