...
**CyberSec Lab** — комплексная веб-платформа для интерактивного изучения основ информационной безопасности, веб-безопасности и безопасной разработки. Платформа объединяет **8 обучающих модулей**, систему тестирования с таймером (**136 вопросов** по 9 категориям), лабораторные работы по SQL-инъекциям, XSS, CSRF, ревью кода, криптографические инструменты, систему достижений (**16 достижений**) и глоссарий из **93 терминов**.
...
- **136 вопросов квиза** по 9 категориям с таймером и фильтрацией по сложности
- **16 лабораторных заданий** по SQL-инъекциям: от обхода аутентификации до WAF Bypass
- **9 типов XSS** с интерактивной демонстрацией атак
- **35 задач по ревью кода**: SQLi, XSS, IDOR, SSRF, XXE, SSTI, Prompt Injection и др.
- **12 HTTP-заголовков безопасности** с квизами по каждому
- **Криптографические инструменты**: шифры, кодирование, хеши, генератор паролей, JWT decoder, AES демо
- **16 достижений** — мотивирующие бейджи за прогресс
- **Глоссарий из 93 терминов** с поиском и фильтрацией
